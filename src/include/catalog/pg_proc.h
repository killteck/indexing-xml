...
DESCR("is the range's lower bound empty?");
...
DATA(insert OID = 3856 (  range_neq	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 16 "3831 3831" _null_ _null_ _null_ _null_ range_neq _null_ _null_ _null_ ));
DESCR("are the two ranges not equal?");
DATA(insert OID = 3857 (  contains	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 16 "3831 2283" _null_ _null_ _null_ _null_ range_contains_elem _null_ _null_ _null_ ));
DESCR("does the range contain the point?");
DATA(insert OID = 3858 (  contains	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 16 "3831 3831" _null_ _null_ _null_ _null_ range_contains _null_ _null_ _null_ ));
DESCR("does the range contain the other range?");
DATA(insert OID = 3859 (  contained_by	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 16 "3831 3831" _null_ _null_ _null_ _null_ range_contained_by _null_ _null_ _null_ ));
DESCR("is the range contained by the other range?");
DATA(insert OID = 3860 (  overlaps	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 16 "3831 3831" _null_ _null_ _null_ _null_ range_overlaps _null_ _null_ _null_ ));
DESCR("do the two ranges overlap?");
DATA(insert OID = 3861 (  adjacent	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 16 "3831 3831" _null_ _null_ _null_ _null_ range_adjacent _null_ _null_ _null_ ));
DESCR("are the two ranges adjacent?");
DATA(insert OID = 3862 (  before	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 16 "3831 3831" _null_ _null_ _null_ _null_ range_before _null_ _null_ _null_ ));
DESCR("is the range before the other range?");
DATA(insert OID = 3863 (  after	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 16 "3831 3831" _null_ _null_ _null_ _null_ range_after _null_ _null_ _null_ ));
DESCR("is the range after the other range?");
DATA(insert OID = 3864 (  overleft	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 16 "3831 3831" _null_ _null_ _null_ _null_ range_overleft _null_ _null_ _null_ ));
DESCR("is the range after the other range?");
DATA(insert OID = 3865 (  overright	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 16 "3831 3831" _null_ _null_ _null_ _null_ range_overright _null_ _null_ _null_ ));
DESCR("is the range after the other range?");
DATA(insert OID = 3866 (  range_union	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 3831 "3831 3831" _null_ _null_ _null_ _null_ range_union _null_ _null_ _null_ ));
DESCR("the union of the two ranges");
DATA(insert OID = 3867 (  range_intersect	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 3831 "3831 3831" _null_ _null_ _null_ _null_ range_intersect _null_ _null_ _null_ ));
DESCR("the intersection of the two ranges");
DATA(insert OID = 3868 (  minus	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 3831 "3831 3831" _null_ _null_ _null_ _null_ range_minus _null_ _null_ _null_ ));
