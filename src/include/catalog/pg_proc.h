...
DESCR("I/O");
DATA(insert OID = 3838 (  range	PGNSP PGUID 12 1 0 0 f f f f f i 1 0 3831 "2283" _null_ _null_ _null_ _null_ range_make1 _null_ _null_ _null_ ));
DESCR("construct a range from a single point");
DATA(insert OID = 3839 (  range	PGNSP PGUID 12 1 0 0 f f f f f i 2 0 3831 "2283 2283" _null_ _null_ _null_ _null_ range _null_ _null_ _null_ ));
DESCR("construct a left-inclusive range from two points");
DATA(insert OID = 3840 (  range__	PGNSP PGUID 12 1 0 0 f f f f f i 2 0 3831 "2283 2283" _null_ _null_ _null_ _null_ range__ _null_ _null_ _null_ ));
DESCR("construct an exclusive range from two points");
DATA(insert OID = 3841 (  range_i	PGNSP PGUID 12 1 0 0 f f f f f i 2 0 3831 "2283 2283" _null_ _null_ _null_ _null_ range_i _null_ _null_ _null_ ));
DESCR("construct a right-inclusive range from two points");
DATA(insert OID = 3842 (  rangei_	PGNSP PGUID 12 1 0 0 f f f f f i 2 0 3831 "2283 2283" _null_ _null_ _null_ _null_ rangei_ _null_ _null_ _null_ ));
DESCR("construct a left-inclusive range from two points");
DATA(insert OID = 3843 (  rangeii	PGNSP PGUID 12 1 0 0 f f f f f i 2 0 3831 "2283 2283" _null_ _null_ _null_ _null_ rangeii _null_ _null_ _null_ ));
DESCR("construct an inclusive range from two points");
DATA(insert OID = 3844 (  range_linf_	PGNSP PGUID 12 1 0 0 f f f f f i 1 0 3831 "2283" _null_ _null_ _null_ _null_ range_linf_ _null_ _null_ _null_ ));
DESCR("construct a range with an infinite lower bound and exclusive upper bound");
DATA(insert OID = 3845 (  range_uinf_	PGNSP PGUID 12 1 0 0 f f f f f i 1 0 3831 "2283" _null_ _null_ _null_ _null_ range_uinf_ _null_ _null_ _null_ ));
DESCR("construct a range with an infinite upper bound and exclusive lower bound");
DATA(insert OID = 3846 (  range_linfi	PGNSP PGUID 12 1 0 0 f f f f f i 1 0 3831 "2283" _null_ _null_ _null_ _null_ range_linfi _null_ _null_ _null_ ));
DESCR("construct a range with an infinite lower bound and inclusive upper bound");
DATA(insert OID = 3847 (  range_uinfi	PGNSP PGUID 12 1 0 0 f f f f f i 1 0 3831 "2283" _null_ _null_ _null_ _null_ range_uinfi _null_ _null_ _null_ ));
DESCR("construct a range with an infinite upper bound and inclusive lower bound");
DATA(insert OID = 3848 (  range_lbound	PGNSP PGUID 12 1 0 0 f f f t f i 1 0 2283 "3831" _null_ _null_ _null_ _null_ range_lbound _null_ _null_ _null_ ));
DESCR("return the range's lower bound");
DATA(insert OID = 3849 (  range_ubound	PGNSP PGUID 12 1 0 0 f f f t f i 1 0 2283 "3831" _null_ _null_ _null_ _null_ range_ubound _null_ _null_ _null_ ));
...
DATA(insert OID = 3851 (  lbound_inf	PGNSP PGUID 12 1 0 0 f f f t f i 1 0 16 "3831" _null_ _null_ _null_ _null_ range_lb_inf _null_ _null_ _null_ ));
DESCR("is the range's lower bound infinite?");
DATA(insert OID = 3852 (  ubound_inf	PGNSP PGUID 12 1 0 0 f f f t f i 1 0 16 "3831" _null_ _null_ _null_ _null_ range_ub_inf _null_ _null_ _null_ ));
DESCR("is the range's upper bound infinite?");
DATA(insert OID = 3853 (  range_eq	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 16 "3831 3831" _null_ _null_ _null_ _null_ range_eq _null_ _null_ _null_ ));
DESCR("are the two ranges equal?");
DATA(insert OID = 3854 (  range_neq	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 16 "3831 3831" _null_ _null_ _null_ _null_ range_neq _null_ _null_ _null_ ));
DESCR("are the two ranges not equal?");
DATA(insert OID = 3855 (  contains	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 16 "3831 2283" _null_ _null_ _null_ _null_ range_contains_elem _null_ _null_ _null_ ));
DESCR("does the range contain the point?");
DATA(insert OID = 3856 (  contains	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 16 "3831 3831" _null_ _null_ _null_ _null_ range_contains _null_ _null_ _null_ ));
DESCR("does the range contain the other range?");
DATA(insert OID = 3857 (  contained_by	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 16 "3831 3831" _null_ _null_ _null_ _null_ range_contained_by _null_ _null_ _null_ ));
DESCR("is the range contained by the other range?");
DATA(insert OID = 3858 (  overlaps	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 16 "3831 3831" _null_ _null_ _null_ _null_ range_overlaps _null_ _null_ _null_ ));
DESCR("do the two ranges overlap?");
DATA(insert OID = 3859 (  adjacent	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 16 "3831 3831" _null_ _null_ _null_ _null_ range_adjacent _null_ _null_ _null_ ));
DESCR("are the two ranges adjacent?");
DATA(insert OID = 3860 (  before	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 16 "3831 3831" _null_ _null_ _null_ _null_ range_before _null_ _null_ _null_ ));
DESCR("is the range before the other range?");
DATA(insert OID = 3861 (  after	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 16 "3831 3831" _null_ _null_ _null_ _null_ range_after _null_ _null_ _null_ ));
DESCR("is the range after the other range?");
DATA(insert OID = 3862 (  overleft	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 16 "3831 3831" _null_ _null_ _null_ _null_ range_overleft _null_ _null_ _null_ ));
DESCR("is the range after the other range?");
DATA(insert OID = 3863 (  overright	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 16 "3831 3831" _null_ _null_ _null_ _null_ range_overright _null_ _null_ _null_ ));
DESCR("is the range after the other range?");
DATA(insert OID = 3864 (  range_union	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 3831 "3831 3831" _null_ _null_ _null_ _null_ range_union _null_ _null_ _null_ ));
DESCR("the union of the two ranges");
DATA(insert OID = 3865 (  range_intersect	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 3831 "3831 3831" _null_ _null_ _null_ _null_ range_intersect _null_ _null_ _null_ ));
DESCR("the intersection of the two ranges");
DATA(insert OID = 3866 (  minus	PGNSP PGUID 12 1 0 0 f f f t f i 2 0 3831 "3831 3831" _null_ _null_ _null_ _null_ range_minus _null_ _null_ _null_ ));
